  ...
  <div class="hero_area">
    ...
    <div class="search_slider" style="background-color: white;">
      ...
      <div class="input-group" style="width:40%; margin-left:32%; margin-top:3%">
        <input type="text" class="form-control" name="search" placeholder="Search for restaurant, food or grocery">
        <div class="input-group-append">
          <button class="btn btn-secondary" type="submit" id="searchbtn" name="searchbtn">
            ...
            <?php
                if(isset($_GET['searchbtn']))
                {
                    ...
                    if($count > 0)
                    {
                        ...
                        {
                            echo ' <div style="margin-left: 5px; height:400px; width:300px;"  class="card" style="width: 18rem;">
                            <div class="card-body">
                            <form method="POST" action="add_to_cart.php? item_id='.$row['item_id'].'">
                            <img style="margin-top:20px; margin-left:35px; margin-bottom:10px; height:220px; width:220px;" src="uploads/'.$row['image'].'" class="card-img-top">
                            <div style="margin-left:35px;">
                                <h5 style=" font-weight:bold; margin-bottom:23px;"> '.$row['name'].' </h5>
                                <h5 style="margin-bottom:23px;" class="card-title">
                                Price: 
                                ₹'.$row['price'].'</h5>
                                <h5 style="min-inline-size: fit-content;" > '.$row['category'].'</h5>
      ...
      <section id="ss" class="slider_section">
        <div id="customCarousel1" class="carousel slide" data-ride="carousel">
          <div style="margin-left: 150px; width:1200px; height:420px;" class="carousel-inner">
            <div class="carousel-item active">
              <div class="container ">
                <div class="row">
                  <div class="col-md-7 col-lg-6 ">
                    <div class="detail-box">
                      <img style="height:420px; width:1200px;" src="images/pz.png">
                      <div class="btn-box">
                        <a href="" class="btn1">
                          Order Now
                        </a>
            ...
            <div class="carousel-item ">
              <div class="container ">
                <div class="row">
                  <div class="col-md-7 col-lg-6 ">
                    <div class="detail-box">
                      <img style="width:1200px; height:420px;" src="images/grocery30.png">
                      <div class="btn-box">
                        <a href="" class="btn1">
                          Order Now
                        </a>
            ...
            <div class="carousel-item">
              <div class="container ">
                <div class="row">
                  <div class="col-md-7 col-lg-6 ">
                    <div class="detail-box">
                      <img style="height:420px; width:1200px;" src="images/dosa.png">
                      <div class="btn-box">
                        <a href="" class="btn1">
                          Order Now
                        </a>
    ...
    <script>
      document.getElementById('searchbtn').onclick = function() {
        document.getElementByClass('ss').style.display = "none";
        // location.reload();
    };  
    </script>
    <!-- jQery -->
